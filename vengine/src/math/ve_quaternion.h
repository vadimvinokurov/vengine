...
struct Quaternion {
   __forceinline Quaternion() noexcept
      : x(0.0f)
      , y(0.0f)
      , z(0.0f)
      , w(1.0f)
   ...
   __forceinline Quaternion(float x_, float y_, float z_, float w_) noexcept
      : x(x_)
      , y(y_)
      , z(z_)
      , w(w_)
   ...
   __forceinline Quaternion(float fillValue) noexcept
      : x(fillValue)
      , y(fillValue)
      , z(fillValue)
      , w(fillValue)
   ...
   __forceinline Quaternion(const Vector3& v, float w_ = 0.0f) noexcept
      : x(v.x)
      , y(v.y)
      , z(v.z)
      , w(w_)
   ...
   __forceinline Quaternion(const Vector4& v) noexcept
      : x(v.x)
      , y(v.y)
      , z(v.z)
      , w(v.w)
   ...
   __forceinline Quaternion(const float* fv) noexcept
      : x(fv[0])
      , y(fv[1])
      , z(fv[2])
      , w(fv[3])
   ...
   {
      return (fabsf(this->x - other.x) < VE::EPSILON && fabsf(this->y - other.y) < VE::EPSILON && fabsf(this->z - other.z) < VE::EPSILON && fabsf(this->w - other.w) < VE::EPSILON);
   }
   ...
   {
      return (fabsf(this->x - other.x) < VE::EPSILON &&
              fabsf(this->y - other.y) < VE::EPSILON &&
              fabsf(this->z - other.z) < VE::EPSILON &&
              fabsf(this->w - other.w) < VE::EPSILON) ||
             (fabsf(this->x + other.x) < VE::EPSILON &&
              fabsf(this->y + other.y) < VE::EPSILON &&
              fabsf(this->z + other.z) < VE::EPSILON &&
              fabsf(this->w + other.w) < VE::EPSILON);
   }
